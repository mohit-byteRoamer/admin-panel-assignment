    ...
    <div className="flex items-center justify-center p-6">
      <div className="max-w-2xl w-full bg-gradient-to-br from-white to-gray-50 rounded-2xl p-8 shadow-[0_0_50px_-12px_rgb(0,0,0,0.12)] border border-gray-100">
        ...
        <h1 className="text-4xl font-light text-gray-800 mb-4">
          Development in
          <span className="font-medium block mt-2 bg-gradient-to-r from-[#399797] to-[#2d7676] bg-clip-text text-transparent">
            Progress
          </span>
        </h1>

        <p className="text-gray-600 leading-relaxed">
          This module is currently under active development. Our team is working on implementing core features and
          ensuring optimal performance for seamless integration with your existing systems.
        </p>
        ...
        <div className="mt-6 flex items-center gap-4">
          <Link className="bg-primary text-white p-2 px-4 hover:text-white font-semibold rounded-md" href={ROUTES.TELEMARKETING}>Go to Tasks</Link>,
        </div>
      </div>
    </div>
  );
...
export default DevProgressCard;
